...
$execute store result score 1 temp.fill run fill $(a_x) -64 $(a_z) $(b_x) 319 $(b_z) air replace deepslate
$execute store result score 2 temp.fill run fill $(a_x) -64 $(a_z) $(b_x) 319 $(b_z) air replace stone
